...
def test_delete_item_success(mocker):
    ...
    mock_load = mocker.patch("backend.app.services.cartInteractor.load_json")
    mock_load.return_value = mock_cart_data
    
    mock_write = mocker.patch("backend.app.services.cartInteractor.write_to_json")
    
    from backend.app.services.cartInteractor import delete_item
...
def test_delete_item_endpoint_success(mocker):
    ...
    mock_delete = mocker.patch("backend.app.routers.cartRouter.delete_item")

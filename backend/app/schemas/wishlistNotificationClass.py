...
class WishlistNotification(Notification):
    ...
    def discount_percent(self):
        return round(((self._old_price - self._new_price) / self._old_price) * 100, 1)
    
    def get_message(self) -> str:
        return f"Price drop! {self._product_name} is now ${self._new_price:.2f} (was ${self._old_price:.2f}) - {self.discount_percent}% off!"

...
from app.services.userInteractor import update_password

@pytest.fixture
def mock_user_data():
    with patch("app.services.userInteractor.load_json") as mock_load, \
         patch("app.services.userInteractor.write_to_json") as mock_write:

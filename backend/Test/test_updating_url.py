...
def test_update_image_url_success(monkeypatch):
    ...
    monkeypatch.setattr("app.services.userInteractor.load_json", mock_load_json)
    monkeypatch.setattr("app.services.userInteractor.write_to_json", mock_write_to_json)
